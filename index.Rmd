...
# quanteda: Quantitative using **quanteda** requires R programming
...
- **quanteiiiiiiiilots**: plots for textual data, namely the `textplot_*()` functions, split with the v3 release
